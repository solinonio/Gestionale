...
export default function PresentationTextForm() {
  const [profile, setProfile] = useState<CompanyInfo>({ name: '', address: '', cap: '', city: '', phone: '', email: '', vatNumber: '', sdiCode: '', pec: '', presentationText: '' });
  ...
  return (
    <form onSubmit={handleSubmit} className="h-full flex flex-col">
      <QuillEditor 
        ...
        onChange={content => setProfile({...profile, presentationText: content})}
      />
